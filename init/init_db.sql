...
ALTER TABLE `penilaian`
  ADD CONSTRAINT `penilaian_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tugas` (`id`)  ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `penilaian_ibfk_2` FOREIGN KEY (`NIM`) REFERENCES `peserta` (`NIM`)  ON DELETE CASCADE ON UPDATE NO ACTION;
